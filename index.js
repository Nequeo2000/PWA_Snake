...
function rewardSnake(n) {
    for (let i = 0; i < inputHistory.length; i++) {
        ...
        snakeBrain[inputHistory[i]][output] += n * Math.pow(2, -i);
    }
}
